...
*After cloning the repo and installing the required gems, cd into chess/lib 

1. Start the game by running:
   ruby display_tester.rb
...
4. The game will notify you if you're in check, and you must make a move to get out of check. 

5. Pieces that can't get your king out of check won't be selected. 
